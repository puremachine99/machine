  ...
  while ($row = mysqli_fetch_assoc($res)) {
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
          Kategori
          <small>Tulis Kategori untuk mengelompokkan item </small>
        </h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="fa fa-dashboard"></i> Menu</a></li>
          <li class="active">Tulis Kategori</li>
        </ol>
      </section>
        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="box">
              ...
              <div class="box-body">
                <form method="post" action="tulis_kategori.php">
                  <div class="col-xs-2">
                    <label>Kategori :</label>
                    <input type="text" name="kategori" class="form-control <?= colors(call("theme")) ?>">
                  </div>
                  <div class="col-xs-12">
                    <br>
                    <button type="submit" class="btn btn-success pull-right" name="tambah"><span class="fa fa-plus"></span> Kategori Baru</button>
                  </div>
                </form>
              </div>
